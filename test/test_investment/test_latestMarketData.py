...
class TestLatestMarketData:
    ...
    def test_demand_data(self, latest_market_data):
        ...
        logger.debug("regression: {}".format(market_data.agent_forecast_demand(4)))
    ...
    @pytest.mark.parametrize("price_needed, expected_output",
                            [
    ...
    def test_switch_statements_for_price_data(self, latest_market_data, price_needed, expected_output):
        assert latest_market_data._switch_statements_for_price_data(price_needed) == expected_output

    def test_switch_statements_for_valueerror_for_price_data(self, latest_market_data):
