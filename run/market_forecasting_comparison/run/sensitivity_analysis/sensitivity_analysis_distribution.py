...
if __name__ == '__main__':
    ...
    #     print(resultant_dists)
        ...
        returned_result = Parallel(n_jobs=multiprocessing.cpu_count()-1)(delayed(run_world)(carbon_list, resultant_dists, dist_object) for _ in range(0, 100))
