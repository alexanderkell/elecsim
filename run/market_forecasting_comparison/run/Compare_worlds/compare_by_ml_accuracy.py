...
if __name__ == '__main__':
    ...
    result_distributions_object.pop('{"C": 2, "fit_intercept": false, "max_iter": 1, "shuffle": false, "tol": 0.001}')
    ...
    for resultant_dists in result_distributions_object:
        ...
        Parallel(n_jobs=multiprocessing.cpu_count()-1, verbose=51)(delayed(run_world)(carbon_list, resultant_dists, dist_object) for _ in range(0, 100))
