...
if __name__ == '__main__':
    ...
    for resultant_dists in result_distributions_object:
        ...
        #     # run_world.remote(number_of_steps, dist_object, prices_individual, carbon_list)
        #     run_world(number_of_steps, dist_object, prices_individual, carbon_list)
        # with multiprocessing.Pool(processes=7) as pool:
        # Parallel
        Parallel(n_jobs=7)(run_world(number_of_steps, dist_object, prices_individual, carbon_list) for i in range(150))
