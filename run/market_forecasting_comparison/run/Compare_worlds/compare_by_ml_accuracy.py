...
# @ray.remote
def run_world(num_steps=number_of_steps, demand_distribution=None, long_term_fitting_params=None):
    world = World(initialization_year=2018, market_time_splices=MARKET_TIME_SPLICES, data_folder="results", number_of_steps=number_of_steps, scenario_file=scenario_file, demand_distribution=demand_distribution, long_term_fitting_params=long_term_fitting_params)
...
if __name__ == '__main__':
    ...
    for resultant_dists in result_distributions_object:
        ...
        for j in range(150):
            ...
            run_world(number_of_steps, dist_object, prices_individual)
