...
if __name__ == '__main__':
    os.chdir("{}/run/batchrunners/scenarios/data/second_batch_run_2018/".format(ROOT_DIR))
    for file_name in glob.glob('*.csv'):
       ...
       'Recip_gas'])
        ...
        figure.savefig('{}/run/batchrunners/scenarios/figures/second_batch_run_2018/{}{}.png'.format(ROOT_DIR, file_name.split(".")[0],file_name.split(".")[1]))
        plt.close('all')
