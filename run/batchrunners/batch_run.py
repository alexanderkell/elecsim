...
if __name__ == '__main__':
    ...
    #                }
    # variable_params = {"carbon_price_scenario": [[0]*50, [10]*50 ,[20]*50, [40]*50, [50]*50,[70]*50, list(range(18, 178, 4)), list(range(178, 18, -4)) ],"demand_change": [[1.01]*50, [0.99]*50]}


    variable_params = {"carbon_price_scenario": [[30] * 50],"demand_change": [[1.01] * 50]}
