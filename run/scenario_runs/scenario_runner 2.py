...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        data_folder = "run_scenarios"
    else:
        data_folder = sys.argv[1]

    scenario_2018 = "reference_scenario_2018.py"
    ...
    variable_params = {"demand_change": [[0.99]* number_of_steps, [0.98]* number_of_steps, [0.97]* number_of_steps, [1.00]* number_of_steps, [1.01]* number_of_steps, [1.02]* number_of_steps, [1.025]* number_of_steps]}
